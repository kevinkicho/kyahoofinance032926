...
function WatchlistMarket({ onNavigate }) {
  ...
  // Fetch all tickers on mount and when tickers change
  useEffect(() => {
    tickers.forEach(t => {
    ...
    // Clean up removed tickers from ref
  ...
  return (
    <div className="watch-market">
      ...
      <div className="watch-content">
        {activeTab === 'tickers' && (
          <>
            <div className="watch-add-bar">
              ...
              <span className="watch-ticker-limit">{tickers.length}/{MAX_TICKERS}</span>
            </div>
        ...
        {activeTab === 'metrics' && (
          <>
            <div className="watch-metrics-hint">
              Click the star to favorite a metric. Click the card to navigate to that market.
            </div>
