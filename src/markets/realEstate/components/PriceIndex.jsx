    ...
    <div className="re-panel">
      ...
      <div className="re-wide-narrow">
        <div className="re-chart-panel">
          ...
          <div className="re-mini-chart">
            <SafeECharts option={bisOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Global House Price Indices (BIS)', source: 'BIS', endpoint: '/api/realEstate', series: [] }} />
          </div>
        </div>
        <div className="re-chart-panel">
      ...
      {csOption && (
        <div className="re-chart-panel" style={{ marginTop: 12, height: 140, flexShrink: 0 }}>
          ...
          <div className="re-mini-chart">
            <SafeECharts option={csOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Case-Shiller National Home Price Index', source: 'FRED', endpoint: '/api/realEstate', series: [{ id: 'CSUSHPISA' }] }} />
          </div>
        </div>
      )}
      ...
      {startsOption && (
        <div className="re-chart-panel" style={{ marginTop: 8, height: 150, flexShrink: 0 }}>
          ...
          <div className="re-mini-chart">
            <SafeECharts option={startsOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Housing Starts & Building Permits', source: 'FRED', endpoint: '/api/realEstate', series: [{ id: 'HOUST' }, { id: 'PERMIT' }] }} />
          </div>
        </div>
      )}
      ...
      {salesOption && (
        <div className="re-chart-panel" style={{ marginTop: 8, height: 140, flexShrink: 0 }}>
          ...
          <div className="re-mini-chart">
            <SafeECharts option={salesOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Existing Home Sales', source: 'FRED', endpoint: '/api/realEstate', series: [{ id: 'EXISTSALE' }] }} />
          </div>
        </div>
      )}
