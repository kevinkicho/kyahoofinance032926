        ...
        {pieOption && (
          <div className="inst-chart-panel">
            ...
            <div className="inst-chart-wrap">
              <SafeECharts option={pieOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Aggregate Top Holdings', source: 'SEC EDGAR 13F', endpoint: '/api/equityDeepDive', series: [] }} />
            </div>
          </div>
        )}
        <div className="inst-chart-panel">
          ...
          <div className="inst-chart-wrap">
            <SafeECharts option={barOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Assets Under Management', source: 'SEC EDGAR 13F', endpoint: '/api/equityDeepDive', series: [] }} />
          </div>
        </div>
      </div>
