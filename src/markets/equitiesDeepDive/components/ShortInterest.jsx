      ...
      <div className="eq-two-col">
        <div className="eq-chart-panel">
          ...
          <div className="eq-chart-wrap">
            <SafeECharts option={shortedOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Most Shorted', source: 'Yahoo Finance', endpoint: '/api/equityDeepDive', series: [] }} />
          </div>
        </div>
        <div className="eq-chart-panel">
          ...
          <div className="eq-chart-wrap">
            <SafeECharts option={squeezeOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Squeeze Watch', source: 'Yahoo Finance', endpoint: '/api/equityDeepDive', series: [] }} />
          </div>
        </div>
      </div>
    </div>
