  ...
  return {
    ...
    tooltip: {
      ...
      formatter: (params) => {
        ...
        return `<b>${s.code || s.name}</b><br/>1D: <b>${d >= 0 ? '+' : ''}${d.toFixed(2)}%</b><br/>1M: <b>${v >= 0 ? '+' : ''}${v.toFixed(2)}%</b>${vsSpy != null ? `<br/>vs SPY: ${vsSpy >= 0 ? '+' : ''}${vsSpy.toFixed(2)}pp` : ''}<br/>1Y: <b>${y >= 0 ? '+' : ''}${y.toFixed(2)}%</b>`;
      },
    },
        ...
        {summary && (
          <div className="eqd-kpi-pill-grid">
            <div className="eqd-kpi-pill">
              ...
              <span className="eqd-kpi-pill-sub">+{(summary.best.perf1m ?? 0).toFixed(1)}%</span>
            </div>
            <div className="eqd-kpi-pill">
              ...
              <span className="eqd-kpi-pill-sub">{(summary.worst.perf1m ?? 0).toFixed(1)}%</span>
            </div>
            <div className="eqd-kpi-pill">
