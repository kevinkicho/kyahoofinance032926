      ...
      <div className="mac-two-col">
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={debtOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Government Debt (% of GDP)', source: 'World Bank', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={currentAcctOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Current Account Balance (% of GDP)', source: 'World Bank', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
      </div>
        ...
        <div className="mac-two-col" style={{ marginTop: 16 }}>
          {yieldSpread && (
            <div className="mac-chart-panel">
              ...
              <div className="mac-chart-wrap">
                <SafeECharts option={yieldSpreadOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Yield Spread — 10Y minus 2Y', source: 'FRED', endpoint: '/api/globalMacro', series: [{ id: 'T10Y2Y' }] }} />
              </div>
            </div>
          )}
          {m2Growth && (
            <div className="mac-chart-panel">
              ...
              <div className="mac-chart-wrap">
                <SafeECharts option={m2GrowthOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'M2 Money Supply Growth (YoY %)', source: 'FRED', endpoint: '/api/globalMacro', series: [{ id: 'M2SL' }] }} />
              </div>
            </div>
          )}
        </div>
