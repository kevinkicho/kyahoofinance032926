      ...
      <div className="mac-two-row">
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={rankedOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Policy Rates — Ranked', source: 'FRED', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={historyOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: '5-Year Rate History', source: 'FRED', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
      </div>
    </div>
