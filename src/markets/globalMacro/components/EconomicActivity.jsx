  ...
  return (
    <div className="mac-panel">
      ...
      <div className="mac-chart-wrap" style={{ minHeight: 200 }}>
        {option && <SafeECharts option={option} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'CFNAI — Economic Activity', source: 'FRED', endpoint: '/api/globalMacro', series: [{ id: 'CFNAI' }] }} />}
      </div>
