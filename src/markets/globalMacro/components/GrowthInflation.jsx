      ...
      <div className="mac-two-col">
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={gdpOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'GDP Growth (%)', source: 'World Bank', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
        <div className="mac-chart-panel">
          ...
          <div className="mac-chart-wrap">
            <SafeECharts option={cpiOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'CPI Inflation (%)', source: 'World Bank', endpoint: '/api/globalMacro', series: [] }} />
          </div>
        </div>
      </div>
        ...
        <div className="mac-two-col" style={{ marginTop: 16 }}>
          {industrialProd && (
            <div className="mac-chart-panel">
              ...
              <div className="mac-chart-wrap">
                <SafeECharts option={indProdOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Industrial Production (YoY %)', source: 'FRED', endpoint: '/api/globalMacro', series: [{ id: 'INDPRO' }] }} />
              </div>
            </div>
          )}
          {consumerSentiment && (
            <div className="mac-chart-panel">
              ...
              <div className="mac-chart-wrap">
                <SafeECharts option={sentimentOption} style={{ height: '100%', width: '100%' }} sourceInfo={{ title: 'Consumer Sentiment (U. Michigan)', source: 'FRED', endpoint: '/api/globalMacro', series: [{ id: 'UMCSENT' }] }} />
              </div>
            </div>
          )}
        </div>
