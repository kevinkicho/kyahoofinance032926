...
/**
 * Independent panel module: equities:kpi
...
function Body({ ctx }) {
  if (typeof ctx?.__render === 'function') {
    try {
      ...
      console.warn('[panel equities:kpi] __render threw:', e);
      return <EmptyPanelBody message="Panel render error" reason={String(e?.message || e)} />;
    }
  }
  return (
    <EmptyPanelBody
      message={"Key Indices — awaiting data"}
      reason={"equities:kpi"}
    />
  );
}
...
export default definePanel({
  ...
  modulePath: "src/panels/equities/kpi.jsx",
