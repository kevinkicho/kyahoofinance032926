...
/**
 * Independent panel module: insurance:kpi
...
function Body({ ctx }) {
  if (typeof ctx?.__render === 'function') {
    try {
      ...
      console.warn('[panel insurance:kpi] __render threw:', e);
      return <EmptyPanelBody message="Panel render error" reason={String(e?.message || e)} />;
    }
  }
  return (
    <EmptyPanelBody
      message={"Insurance Key Metrics — awaiting data"}
      reason={"insurance:kpi"}
    />
  );
}
...
export default definePanel({
  ...
  modulePath: "src/panels/insurance/kpi.jsx",
