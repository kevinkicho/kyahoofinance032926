...
/**
 * Independent panel module: crypto:sidebar
...
function Body({ ctx }) {
  if (typeof ctx?.__render === 'function') {
    try {
      ...
      console.warn('[panel crypto:sidebar] __render threw:', e);
      return <EmptyPanelBody message="Panel render error" reason={String(e?.message || e)} />;
    }
  }
  return (
    <EmptyPanelBody
      message={"Crypto Summary — awaiting data"}
      reason={"crypto:sidebar"}
    />
  );
}
...
export default definePanel({
  ...
  modulePath: "src/panels/crypto/sidebar.jsx",
