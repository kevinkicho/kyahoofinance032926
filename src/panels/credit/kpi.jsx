...
/**
 * Independent panel module: credit:kpi
...
function Body({ ctx }) {
  if (typeof ctx?.__render === 'function') {
    try {
      ...
      console.warn('[panel credit:kpi] __render threw:', e);
      return <EmptyPanelBody message="Panel render error" reason={String(e?.message || e)} />;
    }
  }
  return (
    <EmptyPanelBody
      message={"Credit Key Metrics — awaiting data"}
      reason={"credit:kpi"}
    />
  );
}
...
export default definePanel({
  ...
  modulePath: "src/panels/credit/kpi.jsx",
