...
const SERIES_MAP = {
  ...
  'skew': { id: 'SKEW', source: 'FRED', name: 'CBOE SKEW Index', url: '/api/derivatives' },
  ...
  'fedRate': { id: 'FEDFUNDS', source: 'FRED', name: 'Federal Funds Rate (Fed)', url: '/api/globalMacro' },
  'ecbRate': { id: 'ECBDFR', source: 'ECB/FRED', name: 'ECB Deposit Facility Rate', url: '/api/globalMacro' },
  'boeRate': { id: 'BOERUKM', source: 'BOE/FRED', name: 'Bank of England Rate', url: '/api/globalMacro' },
  'bojRate': { id: 'IRSTCI01JPM156N', source: 'FRED', name: 'BOJ Policy Rate', url: '/api/globalMacro' },
