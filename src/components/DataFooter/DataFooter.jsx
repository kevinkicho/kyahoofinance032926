...
const SOURCE_META = {
  ...
  reer: { desc: 'BIS real effective exchange rates — trade-weighted currency valuation for major economies (FRED/BIS)', series: [] },
  ...
  bisPropertyPrices: { desc: 'BIS residential property price indices — 40+ economies via FRED Q*R628BIS', series: [] },
