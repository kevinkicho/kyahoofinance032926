...
export const SEARCH_INDEX = [
  ...
  { marketId: 'bls',              label: 'BLS',          subTabs: ['Labor Market', 'Prices', 'Trends'], keywords: ['CPI', 'Non-farm Payrolls', 'Unemployment'] },
  { marketId: 'eia',              label: 'EIA',          subTabs: ['Electricity', 'Emissions', 'Energy Overview'], keywords: ['Energy', 'Oil Production', 'EIA'] },
