...
export const SEARCH_INDEX = [
  ...
  { marketId: 'globalMacro',      label: 'Macro',        icon: '🌐', subTabs: ['Scorecard', 'Growth & Inflation', 'Central Bank Rates', 'Debt Monitor', 'Economic Activity'] },
  { marketId: 'equitiesDeepDive', label: 'Equity+',      icon: '🔍', subTabs: ['Sector Rotation', 'Factor Rankings', 'Earnings Watch', 'Short Interest', 'Inst. Holdings'] },
